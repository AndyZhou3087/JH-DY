...
WXBookDetailsLayer::WXBookDetailsLayer()
{
...
bool WXBookDetailsLayer::init(BookData* bookdata)
{
	...
	m_okbtn->addTouchEventListener(CC_CALLBACK_2(WXBookDetailsLayer::onOk, this));
...
WXBookDetailsLayer* WXBookDetailsLayer::create(BookData* bookdata)
{
	WXBookDetailsLayer *pRet = new WXBookDetailsLayer();
...
void WXBookDetailsLayer::onOk(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
...
void WXBookDetailsLayer::removSelf()
{
