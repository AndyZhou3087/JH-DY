...
bool WXExerciseCancelLayer::init()
{
	...
	okbtn->addTouchEventListener(CC_CALLBACK_2(WXExerciseCancelLayer::onOk, this));

	cocos2d::ui::Button* cancelbtn = (cocos2d::ui::Button*)csbnode->getChildByName("cancelbtn");
	cancelbtn->addTouchEventListener(CC_CALLBACK_2(WXExerciseCancelLayer::onCancel, this));
...
void WXExerciseCancelLayer::initRandSeed() {
...
void WXExerciseCancelLayer::onOk(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
	CommonFuncs::BtnAction(pSender, type);
	if (type == ui::Widget::TouchEventType::ENDED)
	{
		WXBuildingUILayer* parent = (WXBuildingUILayer*)this->getParent();
		parent->resetExercise();
		removSelf();
	}
}

time_t WXExerciseCancelLayer::getNowTime()
{
...
void WXExerciseCancelLayer::onCancel(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
	CommonFuncs::BtnAction(pSender, type);
	if (type == ui::Widget::TouchEventType::ENDED)
	{
...
long long WXExerciseCancelLayer::getNowTimeMs() {
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID || CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
	struct timeval nowTimeval;
	gettimeofday(&nowTimeval, NULL);
...
void WXExerciseCancelLayer::removSelf()
{
	this->removeFromParentAndCleanup(true);
}

bool WXExerciseCancelLayer::isBeforeToday(time_t sec) {
	struct tm *tm;
#if (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32)  
	//win32平台
	time_t timep;
...
long long WXExerciseCancelLayer::getTodayLeftSec() {
