...
USING_NS_CC;
class WXFactionCreateLayer :public Layer, public ServerDataDelegateProtocol, public cocos2d::ui::EditBoxDelegate
{
public:
	WXFactionCreateLayer();
	~WXFactionCreateLayer();

	bool init(int action, FactionListData* modifyfdata);
	virtual void onEnterTransitionDidFinish();
	static WXFactionCreateLayer* create(int action, FactionListData* modifyfdata = NULL);
	void initRandSeed();
	time_t getNowTime();
