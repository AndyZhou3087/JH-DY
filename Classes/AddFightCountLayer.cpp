...
void AddFightCountLayer::loadTime() {
	std::string ts = "";
...
void AddFightCountLayer::saveTime() {

}

void AddFightCountLayer::on1sTimer() {
	int m_countdown = 0;
...
void AddFightCountLayer::initBg()
{
	const Size size = Director::getInstance()->getVisibleSize();
