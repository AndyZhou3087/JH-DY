...
WXBuyOrangeGFLayer::WXBuyOrangeGFLayer()
{
}
...
WXBuyOrangeGFLayer* WXBuyOrangeGFLayer::create()
{
	WXBuyOrangeGFLayer *pRet = new WXBuyOrangeGFLayer();
	if (pRet && pRet->init())
	{
		pRet->autorelease();
	}
...
void WXBuyOrangeGFLayer::jumpDown(cocos2d::Node *node, float dt) {
	if (nullptr == node) {
		return;
	}
...
bool WXBuyOrangeGFLayer::init()
{
	...
	backbtn->addTouchEventListener(CC_CALLBACK_2(WXBuyOrangeGFLayer::onBack, this));
...
void WXBuyOrangeGFLayer::shake(Node * node, float scaleLarge, float scaleSmall) {
	if (NULL == node) {
		return;
	}
...
void WXBuyOrangeGFLayer::onBack(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
...
void WXBuyOrangeGFLayer::shake(Node * node) {
	if (NULL == node) {
		return;
	}
...
std::vector<std::string> WXBuyOrangeGFLayer::getRandQu5Gf()
{
	return vec_qu5gf;
}

bool WXBuyOrangeGFLayer::isPhone() {
