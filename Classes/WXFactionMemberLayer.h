...
class WXFactionMemberLayer :public Layer, public ServerDataDelegateProtocol
{
public:
	WXFactionMemberLayer();
	~WXFactionMemberLayer();
	...
	static WXFactionMemberLayer* create(FactionListData* fldata);
