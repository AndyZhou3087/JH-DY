...
WXBranchMissionLayer::WXBranchMissionLayer()
{
}
...
bool WXBranchMissionLayer::init()
{
	...
	onDropbtn->addTouchEventListener(CC_CALLBACK_2(WXBranchMissionLayer::onDropMisson, this));

	cocos2d::ui::Widget* onClosebtn = (cocos2d::ui::Widget*)csbnode->getChildByName("closebtn");
	onClosebtn->addTouchEventListener(CC_CALLBACK_2(WXBranchMissionLayer::onClose, this));
...
WXBranchMissionLayer* WXBranchMissionLayer::create()
{
	WXBranchMissionLayer *pRet = new WXBranchMissionLayer();
	if (pRet && pRet->init())
	{
		pRet->autorelease();
	}
...
void WXBranchMissionLayer::onDropMisson(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
...
void WXBranchMissionLayer::onClose(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
	CommonFuncs::BtnAction(pSender, type);
	if (type == ui::Widget::TouchEventType::ENDED)
	{
