...
USING_NS_CC;
class WXHSLJFightResultLayer :public Layer, public ServerDataDelegateProtocol
{
public:
	WXHSLJFightResultLayer();
	~WXHSLJFightResultLayer();

	bool init(int myfinalhero, int win);
	static WXHSLJFightResultLayer* create(int myfinalhero, int win);
