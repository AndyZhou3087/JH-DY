...
class FactionPromotionLayer :public Layer, public ServerDataDelegateProtocol
{
public:
	FactionPromotionLayer();
	~FactionPromotionLayer();
	...
	static FactionPromotionLayer* create(FactionMemberData *data, Node* target);
private:
