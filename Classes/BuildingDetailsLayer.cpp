...
void BuildingDetailsLayer::reset() {
	updateBloodBar();
	resetBoss();
}
...
void BuildingDetailsLayer::updateBloodBar() {
...
void BuildingDetailsLayer::updateTime() {
...
void BuildingDetailsLayer::resetBoss() {
...
void BuildingDetailsLayer::onScoreChange() {

	updateBloodBar();
}

void BuildingDetailsLayer::on1sTimer() {
...
void BuildingDetailsLayer::playBossShowEffect(CallFunc * callback) {
	if (nullptr == m_boss) {
		return;
	}
...
void BuildingDetailsLayer::playBossActiveEffect()
{

}


void BuildingDetailsLayer::initBossBombParticleSystem() {
	if (nullptr == m_boss) {
		return;
	}
