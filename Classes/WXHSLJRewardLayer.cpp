...
WXHSLJRewardLayer::WXHSLJRewardLayer()
{
}
...
WXHSLJRewardLayer* WXHSLJRewardLayer::create(int goldcount)
{
	WXHSLJRewardLayer *pRet = new WXHSLJRewardLayer();
...
bool WXHSLJRewardLayer::init(int goldcount)
{
	...
	okbtn->addTouchEventListener(CC_CALLBACK_2(WXHSLJRewardLayer::onGet, this));
...
void WXHSLJRewardLayer::onGet(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type)
{
...
void WXHSLJRewardLayer::onSuccess()
{
...
void WXHSLJRewardLayer::onErr(int errcode)
{
	Director::getInstance()->getRunningScene()->removeChildByName("waitbox");
